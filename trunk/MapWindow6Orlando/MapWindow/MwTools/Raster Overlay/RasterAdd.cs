...
namespace MapWindow.Tools
{
    public class RasterAdd:ITool
    {
        ...
        {
            get { return (TextStrings.AddTwoRasteLayer); }
        }
        ...
        /// <summary>
        /// Executes the Erase Opaeration tool programaticaly, 01/10 Ping Yang changed it for external Testing
        /// </summary>
        ...
        public string HelpText
        {
            get
            {
                return (TextStrings.AddTwoRasteLayer);
            }
        }
        ...
        public void Initialize()
        {
            ...
            _inputParam[1].HelpText = TextStrings.InputSecondRasterforAdding;
        ...
        public string Name
        {
            get { return (TextStrings.AddRasterLayers); }
        }
        ...
        {
            get { return (TextStrings.AddtwoRasterLayers); }
        }
        ...
        {
            get { return (TextStrings.MapWindowRasterAdd); }
        }
