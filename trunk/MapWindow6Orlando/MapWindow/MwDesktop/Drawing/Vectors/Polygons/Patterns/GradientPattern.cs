...
namespace MapWindow.Drawing
{
    ...
    public class GradientPattern : Pattern, IGradientPattern
    {
        ...
        public GradientPattern(Color startColor, Color endColor, double angle, GradientTypes style)
        {
            _gradientType = style;
            _colors = new Color[2];
            _colors[0] = startColor;
        ...
        public override void FillPath(Graphics g, GraphicsPath gp)
        {
            ...
            if (_gradientType == GradientTypes.Linear)
            {
            ...
            else if (_gradientType == GradientTypes.Circular)
            {
            ...
            else if (_gradientType == GradientTypes.Rectangular)
            {
