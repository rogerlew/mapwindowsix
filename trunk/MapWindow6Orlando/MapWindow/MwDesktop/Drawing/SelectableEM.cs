...
namespace MapWindow.Drawing
{
    ...
    /// </summary>
    public static class SelectableEM
    {
        ...
        {
            IEnvelope ignoreMe;
            return self.InvertSelection(tolerant, strict, SelectionModes.Intersects, out ignoreMe);
        }
        ...
        {
            return self.InvertSelection(tolerant,strict, SelectionModes.Intersects, out affectedArea);
        }
        ...
        {
            IEnvelope ignoreMe;
            return self.Select(tolerant, strict, SelectionModes.Intersects, out ignoreMe);
        }
        ...
        {
            return self.Select(tolerant, strict, SelectionModes.Intersects, out affectedArea);
        ...
        {
            IEnvelope ignoreMe;
            return self.UnSelect(tolerant, strict, SelectionModes.Intersects, out ignoreMe);
        }
        ...
        {
            return self.UnSelect(tolerant, strict, SelectionModes.Intersects, out affectedArea);
        }
