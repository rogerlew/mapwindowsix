...
namespace MapWindow.Geometries
{
    ...
    public class GeometryFactory: IGeometryFactory 
    {
        ...
        /// </summary>
        private static GeometryFactory _floatingSingle = new GeometryFactory(new PrecisionModel(PrecisionModels.FloatingSingle));
        ...
        /// </summary>
        private static GeometryFactory _fixed = new GeometryFactory(new PrecisionModel(PrecisionModels.Fixed));
