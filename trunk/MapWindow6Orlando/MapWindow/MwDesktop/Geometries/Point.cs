...
namespace MapWindow.Geometries
{
    ...
    public class Point : Geometry, IPoint
    {
        ...
        private const Coordinate EmptyCoordinate = null;
        ...
        public Point(IGeometryFactory factory):base(factory)
        {
        ...
        public override IList<Coordinate> Coordinates 
        {
            get
            {
                return new List<Coordinate>{_coordinate};
            }
            set
            {
                _coordinate = value[0];
        ...
        /// Dimension
        /// <summary>
        /// Gets or sets the MapWindow.Geometries.Dimensions of this Geometry.
        /// </summary>
        ...
        public int NumOrdinates
        {
            get
            {
                return _coordinate.NumOrdinates;
            }
        }
        ...
        public double[] Values
        {
            ...
            set { _coordinate = new Coordinate(value); }
        }
        ...
        public virtual double Z
        {
            ...
            set
            {
                if (_coordinate == null)
                {
                    _coordinate = new Coordinate(0, 0, 0);
                }
                _coordinate.Z = value;
            }
        }
