...
//
//********************************************************************************************************
// The orginal for this code was obtained from Net Topology Suite
// The code has been modified for use in MapWindow
...
namespace MapWindow.Geometries
{
    ...
    public class CoordinateArraySequence : ICoordinateSequence
    {
        ...
        {
            return new CoordinateArraySequenceEnumerator(_coordinates.GetEnumerator());
        }
        ...
        public virtual double GetOrdinate(int index, Ordinates ordinate)
        {
            switch (ordinate)
            {
                case Ordinates.X: return _coordinates[index].X;
                case Ordinates.Y: return _coordinates[index].Y;
                case Ordinates.Z: return _coordinates[index].Z;
                default:
                    return Double.NaN;
        ...
        public virtual void SetOrdinate(int index, Ordinates ordinate, double value)
        {
            switch (ordinate)
            {
                case Ordinates.X: _coordinates[index].X = value; break;
                case Ordinates.Y: _coordinates[index].Y = value; break;
                case Ordinates.Z: _coordinates[index].Z = value; break;
                case Ordinates.M: _coordinates[index].M = value; break;
                default:
