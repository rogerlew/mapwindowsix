...
namespace MapWindow.Data
{
    ...
    public class Feature : IFeature
    {
        ...
        public Feature(Shape shape)
        {
            ...
            if(shape.Range.FeatureType == FeatureTypes.Point)
            {
            ...
            if(shape.Range.FeatureType == FeatureTypes.MultiPoint)
            {
            ...
            if(shape.Range.FeatureType == FeatureTypes.Line)
            {
            ...
            if(shape.Range.FeatureType == FeatureTypes.Polygon)
            {
        ...
        public Feature(Vertex point):this(new Point(point))
        {
        ...
        /// </summary>
        /// <param name="c"></param>
        public Feature(Coordinate c):this(new Point(c))
        {
        ...
        public Feature(FeatureTypes featureType, IEnumerable<Coordinate> coordinates)
        {
            switch (featureType)
            {
        ...
        /// that can be used in coordination with MapWindow.Analysis
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a MapWindow.Data.CacheTypes enumeration specifying whether the Envelope property
        ...
        public FeatureTypes FeatureType
        {
            get 
            {
                if (_basicGeometry == null) return FeatureTypes.Unspecified;
        ...
        public int NumParts
        {
            get 
            {
                ...
                if (_basicGeometry.FeatureType != FeatureTypes.Polygon)
                    return _basicGeometry.NumGeometries;
        ...
        /// <summary>
        /// Gets or sets a MapWindow.Data.CacheTypes enumeration.  If the value
