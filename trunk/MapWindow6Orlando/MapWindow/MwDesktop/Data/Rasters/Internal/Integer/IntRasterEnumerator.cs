...
namespace MapWindow.Data
{
    ...
    /// RasterEnumerator
    /// </summary>
    internal class IntRasterEnumerator : IEnumerator<IntRaster>, IEnumerator<IRaster>
    {
        

        #region Private Variables

        IEnumerator<IntRaster> _enumrator;
        ...
        public IntRasterEnumerator(List<IntRaster> list)
        {
        ...
        #region IEnumerator<IntRaster> Members

        /// <summary>
        /// Retrieves the current IntRaster from this calculator.
        /// </summary>
        public IntRaster Current
        {
