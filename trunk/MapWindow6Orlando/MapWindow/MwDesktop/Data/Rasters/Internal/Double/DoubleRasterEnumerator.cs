...
//
// The Initial Developer of this Original Code is Ted Dunsford. Created 2/23/2008 1:00:38 PM
// 
...
namespace MapWindow.Data
{
    ...
    /// RasterEnumerator
    /// </summary>
    internal class DoubleRasterEnumerator : IEnumerator<DoubleRaster>, IEnumerator<IRaster>
    {


        #region Private Variables

        IEnumerator<DoubleRaster> _enumrator;
        ...
        public DoubleRasterEnumerator(List<DoubleRaster> list)
        {
        ...
        #region IEnumerator<DoubleRaster> Members

        /// <summary>
        /// Retrieves the current DoubleRaster from this calculator.
        /// </summary>
        public DoubleRaster Current
        {
