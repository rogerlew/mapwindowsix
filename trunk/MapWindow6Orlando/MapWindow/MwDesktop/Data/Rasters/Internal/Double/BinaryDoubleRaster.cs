...
//
// The Initial Developer of this Original Code is Ted Dunsford. Created 2/19/2008 10:37:25 AM
// 
...
namespace MapWindow.Data
{
    ...
    /// BinaryDoubleRaster
    /// </summary>
    internal class BinaryDoubleRaster : DoubleRaster
    {
        #region Constructors
        ...
        public BinaryDoubleRaster(string filename, int numRows, int numColumns) :
        ...
        public BinaryDoubleRaster(string filename, int numRows, int numColumns, bool inRam)
        {
        ...
        public override double[] ReadRow(int row)
        {
            ...
            BinaryReader br = new BinaryReader(fs);
            double[] result = new double[NumColumnsInFile];

            for (int col = 0; col < NumColumnsInFile; col++)
            {
                result[col] = br.ReadDouble();
            }
        ...
        /// <summary>
        /// Saves the data in memory to the current file.
        /// </summary>
        ...
        public override void WriteValue(int row, int column, double value)
        {
