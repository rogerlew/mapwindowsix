...
namespace MapWindow.Map
{
    ...
    public class MapPointLayer : PointLayer, IMapPointLayer
    {
        ...
        public MapPointLayer(IFeatureSet featureSet):base(featureSet)
        {
        ...
        public new static MapPointLayer OpenFile(string filename, IProgressHandler progressHandler)
        {
        ...
        /// <param name="filename">A string filename to create a point layer for.</param>
        /// <returns>A GeoPointLayer created from the specified filename.</returns>
        public new static MapPointLayer OpenFile(string filename)
        {
