...
namespace MapWindow.Main
{
    ...
    /// NullExceptioncs
    /// </summary>
    public class NullLogException : ArgumentNullException, ILogException
    {
        ...
        /// </summary>
        public NullLogException(string parameterName):base(ExceptionMessages.Argument_Null_S.Replace("%S", parameterName))
        {
            Log();
        }
