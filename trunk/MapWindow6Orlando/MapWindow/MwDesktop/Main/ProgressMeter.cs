...
namespace MapWindow.Main
{
    ...
    public class ProgressMeter
    {
        ...
        public ProgressMeter(IProgressHandler progressHandler) : this(progressHandler, "Calculating values.", 100)
        {
        ...
        public ProgressMeter(IProgressHandler progressHandler, string baseMessage) : this(progressHandler, baseMessage, 100)
        {
        ...
        public void Reset()
        {
            ...
            if (_silent == true) return;
            if (_progressHandler == null) return;
            _progressHandler.Progress(_baseMessage, _prog, _baseMessage);
            System.Windows.Forms.Application.DoEvents(); // Allow the form to update a status bar if necessary.
        }
