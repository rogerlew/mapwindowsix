...
namespace MapWindow.Main
{
    ...
    /// </summary>
    public class CollectiveIndexCompareCancel<T> : System.ComponentModel.CancelEventArgs
    {
        ...
        public CollectiveIndexCompareCancel(System.Collections.Generic.IEnumerable<T> inCollection, System.Collections.Generic.IComparer<T> inComparer, int inIndex)
        {
        ...
        /// </summary>
        public virtual System.Collections.Generic.IEnumerable<T> Collection
        {
        ...
        /// </summary>
        public virtual System.Collections.Generic.IComparer<T> Comparer
        {
