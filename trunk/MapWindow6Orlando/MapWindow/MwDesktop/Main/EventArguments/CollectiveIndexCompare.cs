...
namespace MapWindow.Main
{
    ...
    /// </summary>
    public class CollectiveIndexCompare<T> : System.EventArgs
    {
        ...
        public CollectiveIndexCompare(System.Collections.Generic.IEnumerable<T> inCollection, System.Collections.Generic.IComparer<T> inComparer, int inIndex)
        {
