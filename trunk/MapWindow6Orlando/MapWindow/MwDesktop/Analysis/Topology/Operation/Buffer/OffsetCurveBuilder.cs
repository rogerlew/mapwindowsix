...
namespace MapWindow.Analysis.Topology.Operation.Buffer
{
    ...
    {        
        ...
        */
        ...
        private BufferStyles _endCapStyle = BufferStyles.CapRound;
        ...
        /// </summary>
        /// <returns>A List of Coordinate[].</returns>
        public virtual IList GetRingCurve(IList<Coordinate> inputPts, Positions side, double distance)
        {
            IList lineList = new ArrayList();
            Init(distance);
            if (inputPts.Count <= 2)
        ...
        private void ComputeRingBufferCurve(IList<Coordinate> inputPts, Positions side)
        {
            int n = inputPts.Count - 1;
        ...
        private static void ComputeOffsetSegment(ILineSegmentBase seg, Positions side, double distance, ILineSegmentBase offset)
        {
