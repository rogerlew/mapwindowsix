...
namespace MapWindow.Analysis.DataManagement.Shapefile.Shape
{
    ...
    /// It only returns the 
	/// </summary>
	public class ShapeReader : IEnumerable
	{        
		/// <summary>
        ...
        private class ShapefileEnumerator : IEnumerator
        {
            ...
            public bool MoveNext()
            {
                ...
                {
                    // some files cause an error with .PeekChar it seems
                    _shpBinaryReader.Close();
                    return false;
                }
            }
        ...
        /// </summary>
        /// <param name="filename">The filename of the shape file to read (with .shp).</param>        
        public ShapeReader(string filename) : this(filename, new GeometryFactory()) { }        
