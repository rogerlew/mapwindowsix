//********************************************************************************************************
// Product Name: MapWindow.Tools.LineFeatureSetParam
...
namespace MapWindow.Tools.Param
{
    ...
    public class LineFeatureSetParam:Parameter 
    {
        ...
        {
            this.Name = name;
            this.Value = new MapWindow.Data.FeatureSet();
            this.ParamVisible = ShowParamInModel.Always;
            this.ParamType = "MapWindow LineFeatureSet Param";
        ...
        {
            MapWindow.Data.FeatureSet addedFeatureSet = new MapWindow.Data.LineShapefile();
