...
{
    internal class IntElement : DialogElement
    {
        ...
        private void HandleStatusLight()
        {
            ...
            if (Param.DefaultSpecified)
            {
                ...
                else
                {
                    ...
                    LightTipText = MessageStrings.InvalidInteger.Replace("%min", Param.Min.ToString()).Replace("%max", Param.Max.ToString());
                }
            }
            else
            {
        ...
        private void InitializeComponent()
        {
            ...
            // textBox1
            // 
            this.txtValue.Location = new System.Drawing.Point(44, 17);
            this.txtValue.Name = "txtValue";
            this.txtValue.Size = new System.Drawing.Size(440, 20);
