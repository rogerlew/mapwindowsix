...
namespace MapWindow.Components
{
    ...
    public class RampSlider : Control
    {
        ...
        void ColorButtonColorChanged(object sender, EventArgs e)
        {
            if (_ignore) return; // prevent infinite loop
            _ignore = true;
            Color c = _colorButton.Color;
            double d = c.GetOpacity() - Value;
        ...
        protected virtual void OnDrawRampText(Graphics g, Rectangle clipRectangle)
        {
            if (_orientation == Orientation.Horizontal)
            {
                ...
                DrawRampTextHorizontal(g, clipRectangle, bounds);
            }
            else
            {
                DrawRampTextVertical(g, clipRectangle);
            }
        }
        ...
        protected virtual void OnDrawRamp(Graphics g, Rectangle clipRectangle)
        {
            ...
            if (_orientation == Orientation.Horizontal)
            {
                DrawRampHorizontal(g, clipRectangle, bounds);
            }
            else
            {
                DrawRampVertical(g, clipRectangle);
            }
        }
        ...
        private void DrawRampHorizontal(Graphics g, Rectangle clipRectangle, RectangleF bounds)
        {
        ...
        private void DrawRampVertical(Graphics g, Rectangle clipRectangle)
        {
            Matrix old = g.Transform;
        ...
        private void DrawRampTextHorizontal(Graphics g, Rectangle clipRectangle, RectangleF bounds)
        {
        ...
        private void DrawRampTextVertical(Graphics g, Rectangle clipRectangle)
        {
            Matrix old = g.Transform;
            Matrix rot = g.Transform;
            if (_invertRamp)
