...
namespace MapWindow.Components
{
    ...
    internal class PatternCollectionControl : UserControl 
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PatternCollectionControl));
        ...
        private void btnDown_Click(object sender, EventArgs e)
        {
            ...
            if (pattern == null) return;
            _patterns.DecreaseIndex<IPattern>(pattern);
            RefreshList();
        ...
        private void btnUp_Click(object sender, EventArgs e)
        {
            ...
            IPattern pattern = lbxItems.SelectedItem as IPattern;
            if (pattern == null) return;
            _patterns.IncreaseIndex<IPattern>(pattern);
            RefreshList();
            lbxItems.SelectedItem = pattern;
            OnOrderChanged();
        }
