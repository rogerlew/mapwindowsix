//********************************************************************************************************
// Product Name: Originally written for Sketchpad, but copied to MapWindow.  
    ...
    internal class AnglePicker : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            if (_angle != 0.0)
            {
                ...
                {
                    g.FillPie(b, circle, (float)(360 - _startAngle - fillAngle), (float)fillAngle);
                }
        ...
        private void DrawCircleBorder(Graphics g, Rectangle circle)
        {
            ...
            Brush b = new System.Drawing.Drawing2D.LinearGradientBrush(circle, Darken(_circleBorderColor, 150), Lighten(_circleBorderColor, 150), 45f);
            p = new Pen(b);
            g.DrawEllipse(p, circle);
            p.Dispose();
