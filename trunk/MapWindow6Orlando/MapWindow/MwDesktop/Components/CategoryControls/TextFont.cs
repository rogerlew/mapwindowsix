...
namespace MapWindow.Components
{
    ...
    public class TextFont : IDisposable
    {
        ...
        /// <param name="g">The Graphics surface to draw to</param>
        /// <param name="text">The string text to draw</param>
        /// <param name="location">The System.Drawing.PointF describing the location to draw</param>
        ...
        /// </summary>
        /// <param name="g">The System.Drawing.Graphics surface to draw to.</param>
        ...
        /// <param name="g">The System.Drawing.Graphics surface to draw to</param>
        /// <param name="text">The string to draw</param>
        /// <param name="box">The System.Drawing.RectangleF structure</param>
