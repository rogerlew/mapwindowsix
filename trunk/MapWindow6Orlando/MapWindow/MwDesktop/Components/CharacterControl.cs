...
namespace MapWindow.Components
{
    ...
    public class CharacterControl : VerticalScrollControl
    {
        ...
        {
            Font = new Font("MapWindowSymbols", 18F, GraphicsUnit.Pixel);
            _typeSet = 0;
            ...
            DocumentRectangle = new Rectangle(0, 0, (int)_cellSize.Width * 16, (int)_cellSize.Height * 16);
            ResetScroll();
        }
        ...
        public int NumRows
        {
            get
            {
                ...
                return (int)Math.Ceiling((double)256 / (double)_numColumns);
            }
        }
        ...
        protected override void OnMouseUp(System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (e.X < 0) return;
            if (e.Y < 0) return;
            int col = (int)((e.X + ControlRectangle.X) / _cellSize.Width);
            int row = (int)((e.Y  + ControlRectangle.Y) / _cellSize.Height);
        ...
        /// </summary>
        /// <param name="e"></param>
        protected override void OnInitialize(System.Windows.Forms.PaintEventArgs e)
        {
            DocumentRectangle = new Rectangle(0, 0, (int)(_numColumns * _cellSize.Width)+1,(int)(NumRows * _cellSize.Height)+1);
            List<char> validChars = new List<char>();
            if (_dynamicColumns)
            {
                int newColumns = (Width - 20) / (int)_cellSize.Width;
            ...
            for (int i = 0; i < 256; i++)
            {
                ...
                e.Graphics.DrawString(text, smallFont, Brushes.Black, new System.Drawing.PointF((float)(col * _cellSize.Width), (float)(row * _cellSize.Height)));
            }
            ...
            if (_isSelected)
            {
                ...
                e.Graphics.DrawString(SelectedString, smallFont, foreBrush, new PointF((float)sRect.X, (float)sRect.Y));
            }
            ...
            if (_isPopup)
            {
                ...
                e.Graphics.DrawString(SelectedString, bigFont, foreBrush, new PointF((float)pRect.X, (float)pRect.Y));
            }
            backBrush.Dispose();
            foreBrush.Dispose();
        }
        ...
        private Rectangle GetPopupRectangle()
        {
            ...
            return new Rectangle((pc - 1) * (int)CellSize.Width, (pr - 1) * (int)CellSize.Height, (int)CellSize.Width * 3, (int)CellSize.Height * 3);
        }
        ...
        private Rectangle GetSelectedRectangle()
        {
            ...
            return new Rectangle((int)(col * _cellSize.Width + 1), (int)(row * _cellSize.Height + 1), (int)(_cellSize.Width - 1), (int)(CellSize.Height - 1));
        }
