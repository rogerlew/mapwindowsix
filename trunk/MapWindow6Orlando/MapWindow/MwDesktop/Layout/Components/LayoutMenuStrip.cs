//********************************************************************************************************
// Product Name: MapWindow.Layout.LayoutMenyStrip
...
namespace MapWindow.Layout
{
    ...
    public class LayoutMenuStrip : MenuStrip
    {
        ...
        void _New_Click(object sender, EventArgs e)
        {
            _layoutControl.NewLayout(true);
        }

        void _Open_Click(object sender, EventArgs e)
        {
        ...
        void _SaveAs_Click(object sender, EventArgs e)
        {
            _layoutControl.SaveLayout(true);
        }

        void _SelectPrinter_Click(object sender, EventArgs e)
        {
            _layoutControl.ShowChoosePrinterDialog();
        }

        void _PageSetup_Click(object sender, EventArgs e)
        {
        ...
        void _SelectConvert_Click(object sender, EventArgs e)
        {
            _layoutControl.ConvertSelectedToBitmap();
        }

        void _SelectDelete_Click(object sender, EventArgs e)
        {
            _layoutControl.DeleteSelected();
        }

        void _SelectMoveDown_Click(object sender, EventArgs e)
        {
            _layoutControl.MoveSelectionDown();
        }

        void _SelectMoveUp_Click(object sender, EventArgs e)
        {
            _layoutControl.MoveSelectionUp();
        }

        void _SelectInvert_Click(object sender, EventArgs e)
        {
            _layoutControl.InvertSelection();
        }

        void _SelectNone_Click(object sender, EventArgs e)
        {
        ...
        void _InsertToolbar_CheckedChanged(object sender, EventArgs e)
        {
        ...
        void _MapToolbar_CheckedChanged(object sender, EventArgs e)
        {
        ...
        void _showMargin_CheckedChanged(object sender, EventArgs e)
        {
        ...
        void _ZoomToolbar_CheckedChanged(object sender, EventArgs e)
        {
        ...
        void _DocToolbar_CheckedChanged(object sender, EventArgs e)
        {
        ...
        void _ZoomFit_Click(object sender, EventArgs e)
        {
