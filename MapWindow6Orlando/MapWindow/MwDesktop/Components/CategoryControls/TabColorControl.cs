...
namespace MapWindow.Components
{
    ...
    public class TabColorControl : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.sldLightness = new MapWindow.Components.TwoColorSlider();
            this.sldSaturation = new MapWindow.Components.TwoColorSlider();
            this.btnHueShift = new System.Windows.Forms.Button();
            this.sldHue = new MapWindow.Components.HueSlider();
            ...
            this.cbEndColor = new MapWindow.Components.ColorButton();
            this.cbStartColor = new MapWindow.Components.ColorButton();
            this.chkUseColorRange = new System.Windows.Forms.CheckBox();
            this.rampSlider1 = new MapWindow.Components.RampSlider();
            this.rampSlider2 = new MapWindow.Components.RampSlider();
            ...
            // btnReverseLight
            // 
            this.btnReverseLight.Image = global::MapWindow.Images.redbluearrows;
            ...
            // btnReverseSat
            // 
            this.btnReverseSat.Image = global::MapWindow.Images.redbluearrows;
            ...
            this.btnReverseHue.Image = global::MapWindow.Images.redbluearrows;
            ...
            // btnHueShift
            // 
            this.btnHueShift.Image = global::MapWindow.Images.RunModel;
        ...
        void btnHueShift_MouseUp(object sender, MouseEventArgs e)
        {
            tmrHueShift.Stop();
        }

        void btnHueShift_MouseDown(object sender, MouseEventArgs e)
        {
            tmrHueShift.Start();
        }
        ...
        void tmrHueShift_Tick(object sender, EventArgs e)
        {
        ...
        private void SetHSL()
        {
            ...
            _startColor = Global.ColorFromHSL(h, s, l).ToTransparent(a);
            _startHue = h;
            _startSat = s;
            _startLight = l;
            ...
            _endSat = s;
            _endLight = l;
            _endColor = Global.ColorFromHSL(h, s, l).ToTransparent(a);            
            _hsl = true;
