//********************************************************************************************************
// Product Name: MapWindow.Tools.RasterParam
...
namespace MapWindow.Tools.Param
{
    ...
    public class RasterParam : Parameter 
    {
        ...
        public RasterParam(string name)
        {
            ...
            this.ParamType = "MapWindow Raster Param";
        }

        /// <summary>
        /// Specifies the value of the parameter (This is also the default value for input)
        /// </summary>
        public new MapWindow.Data.IRaster Value
        {
            get { return (MapWindow.Data.IRaster)base.Value; }
            set
            {
        ...
        {
            this.Value = new MapWindow.Data.Raster();
            this.Value.Filename = path;
        }
