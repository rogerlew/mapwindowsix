//********************************************************************************************************
// Product Name: MapWindow.Tools.PointFeatureSetParam
...
namespace MapWindow.Tools.Param
{
    ...
    public class PointFeatureSetParam : Parameter
    {
        ...
        public PointFeatureSetParam(string name)
        {
            ...
            this.ParamType = "MapWindow PointFeatureSet Param";
        }
        ...
        {
            MapWindow.Data.FeatureSet addedFeatureSet = new MapWindow.Data.PointShapefile();
