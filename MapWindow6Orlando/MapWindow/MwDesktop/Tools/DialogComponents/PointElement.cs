//********************************************************************************************************
// Product Name: MapWindow.Tools.PointElement
// Description:  Point Element for use in the tool dialog
//
//********************************************************************************************************
...
{
    internal class PointElement : DialogElement
    {
            ...
            if (_dataSets != null)
            {
                foreach (DataSetArray dsa in _dataSets)
                {
                    ...
                    if (aFeatureSet != null)
                    {
                        ...
                        if (aFeatureSet.FeatureType == MapWindow.Geometries.FeatureTypes.Point && comboFeatures.Items.Contains(dsa) == false)
                        {
        ...
        private void btnAddData_Click(object sender, EventArgs e)
        {
            ...
            else if (tempFeatureSet.FeatureType != MapWindow.Geometries.FeatureTypes.Point)
