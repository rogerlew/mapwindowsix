//********************************************************************************************************
// Product Name: MapWindow.Tools.RasterElementOut
...
{
    internal class RasterElementOut : DialogElement
    {
        ...
        private void btnAddData_Click(object sender, EventArgs e)
        {
            ...
            {
                IRaster raster = new MapWindow.Data.Raster();
                ...
                else
                {
                    ...
                    textBox1.Text = System.IO.Path.GetFileNameWithoutExtension(raster.Filename);
                    base.Param.Value = raster;
                    base.Status = ToolStatus.Ok;
                    base.LightTipText = MapWindow.MessageStrings.FeaturesetValid;
                }
            }
