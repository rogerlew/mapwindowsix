...
namespace MapWindow.Legacy
{
    ...
    public interface ILayerOld
    {
        ...
        void AddLabel(string Text, Color TextColor, double xPos, double yPos, HJustifications Justification);
        ...
        void AddLabelEx(string Text, Color TextColor, double xPos, double yPos, HJustifications Justification, double Rotation);
