...
namespace MapWindow.Data.IO
{
    ...
    public class WKBWriter
    {
        ...
        protected virtual void Write(IPoint point, BinaryWriter writer)
        {
            ...
            writer.Write((int)WkbGeometryTypes.Point);
        ...
        {
            WriteByteOrder(writer);    
            writer.Write((int)WkbGeometryTypes.LineString);
        ...
        {
            WriteByteOrder(writer);     
            writer.Write((int)WkbGeometryTypes.Polygon);
        ...
        {
            WriteByteOrder(writer);    
            writer.Write((int)WkbGeometryTypes.MultiPoint);
        ...
        {
            WriteByteOrder(writer);     
            writer.Write((int)WkbGeometryTypes.MultiLineString);
        ...
        {
            WriteByteOrder(writer);     
            writer.Write((int)WkbGeometryTypes.MultiPolygon);
        ...
        {
            WriteByteOrder(writer);     
            writer.Write((int)WkbGeometryTypes.GeometryCollection);
