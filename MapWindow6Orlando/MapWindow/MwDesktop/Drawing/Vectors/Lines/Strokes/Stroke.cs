...
namespace MapWindow.Drawing
{
    ...
    public class Stroke : Descriptor, IStroke 
    {
        ...
        public virtual void DrawPath(Graphics g, GraphicsPath path, double scaleWidth)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("Writeline Stroke.DrawPath:" + ex);
            }
            p.Dispose();
        }
        ...
        /// <summary>
        /// Exports the information contained in this stroke to xml
        /// </summary>
        public virtual void WriteXml(System.IO.Stream stream)
        {
            XmlSerializer serializer = new XmlSerializer(_innerStroke.GetType());
            serializer.Serialize(stream, _innerStroke);
        }

        /// <summary>
        /// Writes the xml to the specifeid writer.
        /// </summary>
        /// <param name="writer"></param>
        public virtual void WriteXml(System.Xml.XmlWriter writer)
        {
            XmlSerializer serializer = new XmlSerializer(_innerStroke.GetType());
            serializer.Serialize(writer, _innerStroke);
        ...
        public StrokeStyles StrokeStyle
        {
            get
            {
                if (_innerStroke != null) return _innerStroke.StrokeStyle;
                return StrokeStyles.Simple;
            }
