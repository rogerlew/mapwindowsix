...
namespace MapWindow.Drawing
{
    ...
    public class CharacterSymbol : Symbol, ICharacterSymbol
    {
        ...
        {
            _character = 'A';
            _fontFamilyName = "MapWindowSymbols";
            _color = Color.Green;
            _style = FontStyle.Regular;
            base.SymbolType = SymbolTypes.Character;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IList<CharacterSubsets> GetSupportedSubsets()
        {
            List<CharacterSubsets> result = new List<CharacterSubsets>();
            ...
            Array subsets = Enum.GetValues(typeof(CharacterSubsets));
          
            foreach(CharacterSubsets code in subsets)
            {
        ...
        public System.Globalization.UnicodeCategory Category
        {
