...
namespace MapWindow.Drawing
{
	...
	public class PointSymbolizer : FeatureSymbolizer, IPointSymbolizer
    {
        ...
        public PointSymbolizer(bool selected, IEnvelope extents)
        {
            Configure();

            base.ScaleMode = ScaleModes.Geographic;
        ...
        /// </summary>
        /// <param name="g">The System.Drawing.Graphics object to draw to</param>
        /// <param name="target">The System.Drawing.Rectangle defining the bounds to draw in</param>
        ...
        {
            SymbolTypes type = generator.NextEnum<SymbolTypes>();
            _symbols.Clear();
            switch (type)
            {
                case SymbolTypes.Custom: _symbols.Add(new SimpleSymbol()); break;
                case SymbolTypes.Character: _symbols.Add(new CharacterSymbol()); break;
                case SymbolTypes.Picture: _symbols.Add(new CharacterSymbol()); break;
                case SymbolTypes.Simple: _symbols.Add(new SimpleSymbol()); break;
            }
