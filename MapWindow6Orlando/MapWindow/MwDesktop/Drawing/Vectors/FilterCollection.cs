...
namespace MapWindow.Drawing
{
    ...
    /// FilterCollection
    /// </summary>
    public class FilterCollection : Changeable, IFilterCollection
    {
        ...
        /// <summary>
        /// When changes occur, this invalidates the cached envelope
        /// </summary>
        public override void OnChanged()
        {
            _envelope = null; // invalidate the cached envelope
            base.OnChanged();
        }
