//********************************************************************************************************
// Product Name: MapWindow.Layout.Elements.LayoutScaleBar
// Description:  The scale bar element for use in the MapWindow Layout
//
//********************************************************************************************************
...
namespace MapWindow.Layout.Elements
{
    ...
    public class LayoutScaleBar : LayoutElement 
    {
        ...
        /// </summary>
        void LayoutControlElementsChanged(object sender, EventArgs e)
        {
        ...
        override public void Draw(Graphics g, bool printing)
        {
            ...
            float fontHeight = g.MeasureString(geoBreakWidth.ToString(), _font).Height;
            ...
            for (int i = startBreak; i <= _numBreaks + startBreak; i++)
            {
                ...
                g.DrawString(Math.Abs(geoBreakWidth * i).ToString(), _font, scaleBrush, leftStart - (g.MeasureString(Math.Abs(geoBreakWidth * i).ToString(), _font).Width / 2), 0);
