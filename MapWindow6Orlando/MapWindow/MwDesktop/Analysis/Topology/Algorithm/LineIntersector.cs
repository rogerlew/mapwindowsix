...
namespace MapWindow.Analysis.Topology.Algorithm
{
    ...
    public abstract class LineIntersector 
    {
        ...
        private IntersectionTypes _result;
        ...
        /// <param name="q2"></param>
        /// <returns></returns>
        public abstract IntersectionTypes ComputeIntersect(Coordinate p1, Coordinate p2, Coordinate q1, Coordinate q2);
        ...
        public virtual bool HasIntersection
        {
            get
            {
                return _result != IntersectionTypes.NoIntersection;
            }
        }
        ...
        protected virtual bool IsCollinear
        {
            get
            {
                return _result == IntersectionTypes.Collinear;
            }
        }
        ...
        /// </summary>
        protected IntersectionTypes Result
        {
            get { return _result; }
            set { _result = value; }
        }
