...
using MapWindow.Analysis.DataManagement;
namespace MapWindow.Analysis.DataManagement.Shapefile
{
	...
	public class ShapefileHeader
	{
		...
		public void Write(BigEndianBinaryWriter file) 
		{
			...
			file.Write(_bounds.Minimum.X);
			file.Write(_bounds.Minimum.Y);
			file.Write(_bounds.Maximum.X);
			file.Write(_bounds.Maximum.Y);
			pos += 8 * 4;        
