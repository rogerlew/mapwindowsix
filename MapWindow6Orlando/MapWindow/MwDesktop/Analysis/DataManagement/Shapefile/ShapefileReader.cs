...
namespace MapWindow.Analysis.DataManagement.Shapefile
{
	...
	/// </remarks>
	public class ShapefileReader : IDataReader, IDataRecord, IEnumerable
	{
		/// <summary>
		/// 
		/// </summary>
		internal class ShapefileDataReaderEnumerator : IEnumerator
		{
			...
			public ShapefileDataReaderEnumerator(ShapefileReader parent)
			{
				_parent = parent;
			}
