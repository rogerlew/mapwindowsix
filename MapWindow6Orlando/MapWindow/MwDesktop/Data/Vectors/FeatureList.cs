...
namespace MapWindow.Data
{
    ...
    public class FeatureList : IFeatureList
    {
        ...
        /// <summary>
        /// Sorts the elements in the entire MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt; using the specified comparer.
        /// </summary>
        /// <param name="comparer"> The System.Collections.Generic.IComparer&lt;IFeature&gt; implementation to use when comparing elements, or null to use the default comparer System.Collections.Generic.Comparer&lt;IFeature&gt;.Default.</param>
        ...
        /// <summary>
        /// Sorts the elements in the entire MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt; using the default comparer.
        /// </summary>
        /// <exception cref="System.InvalidOperationException">The default comparer System.Collections.Generic.Comparer&lt;IFeature&gt;.Default cannot find an implementation of the System.IComparable&lt;IFeature&gt; generic interface or the System.IComparable interface for type IFeature.</exception>
        /// <exception cref="System.ApplicationException">Unable to sort while the ReadOnly property is set to true.</exception>
        ...
        /// <summary>
        /// Copies the elements of the MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt; to a new array.
        /// </summary>
        /// <returns>An array containing copies of the elements of the MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt;.</returns>
        ...
        /// <summary>
        /// Sets the capacity to the actual number of elements in the MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt;, if that number is less than a threshold value.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether every element in the MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt; matches the conditions defined by the specified predicate.
        /// </summary>
        /// <param name="match">The System.Predicate&lt;IFeature&gt; delegate that defines the conditions to check against the elements.</param>
        /// <returns>true if every element in the MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt; matches the conditions defined by the specified predicate; otherwise, false. If the list has no elements, the return value is true.</returns>
        /// <exception cref="System.ArgumentNullException">match is null.</exception>
        ...
        /// </summary>
        /// <returns>
        /// The number of elements that the MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt; can contain before resizing is required.
        /// </returns>
        /// <exception cref="System.ArgumentOutOfRangeException">MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt;.Capacity is set to a value that is less than MapWindow.Interfaces.Framework.IEventList&lt;IFeature&gt;.Count.</exception>
