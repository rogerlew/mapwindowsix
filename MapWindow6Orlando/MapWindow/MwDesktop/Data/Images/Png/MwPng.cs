...
namespace MapWindow.Data
{
    ...
    public class MwPng 
    {
        ...
        /// <summary>
        /// Creates a new instance of MwPng
        /// </summary>
        public MwPng()
        {
        ...
        {
            f.Write(ToBytes((uint)data.Length), 0, 4);
            ...
            f.Write(ToBytes(Crc32.ComputeChecksum(combined)), 0, 4);
        ...
        {
            f.Write(ToBytes(1), 0, 4);
            byte[] vals = new byte[]{115, 82, 71, 66, 0}; //sRGB and the value of 0
            f.Write(vals, 0, 5);
            f.Write(ToBytes(Crc32.ComputeChecksum(vals)), 0, 4);
        }

        /// <summary>
        /// Gamma is the gamma times 100000, so 1/2.2 becomes 45455.
        /// The gamma chosen by .Net was 45278 so I am hard coding that for now.
        /// </summary>
        /// <param name="f"></param>
        private static void WriteGama(Stream f)
        {
            f.Write(ToBytes(4), 0, 4);
            byte[] vals = new byte[]{103, 65, 77, 65,0,0,177,143}; // gAMA followed by 45278
            f.Write(ToBytes(Crc32.ComputeChecksum(vals)), 0, 4);
        }
