...
namespace MapWindow.Projections
{
    ...
    public class ProjectionException : Exception
    {
        ...
        public ProjectionException(int errorCode):base(GetMessage(errorCode))
        {
        ...
        public static string GetMessage(int projectionCode)
        {
            ...
            switch (val)
            {
                case 1: return ProjectionMessages.Err1_NoArguments;
                case 2: return ProjectionMessages.Err2_NoOptions;
                case 3: return ProjectionMessages.Err3_NoColon;
                case 4:
