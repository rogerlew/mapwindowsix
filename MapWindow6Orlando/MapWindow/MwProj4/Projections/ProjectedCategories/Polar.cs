...
namespace MapWindow.Projections.ProjectedCategories
{
    ...
    public class Polar : CoordinateSystemCategory
    {
        ...
        public Polar()
        {
            ...
            UPSNorth = new ProjectionInfo("+proj=stere +lat_0=90 +lon_0=0 +k=.994 +x_0=2000000 +y_0=2000000 +ellps=WGS84 +datum=WGS84 +units=m +no_defs ");
            UPSSouth = new ProjectionInfo("+proj=stere +lat_0=-90 +lon_0=0 +k=.994 +x_0=2000000 +y_0=2000000 +ellps=WGS84 +datum=WGS84 +units=m +no_defs ");
