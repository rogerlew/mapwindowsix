//********************************************************************************************************
// Product Name: MapWindow.Tools.mwRasterMultiply
// Description:  Multiply two rasters values cell by cell
//
//********************************************************************************************************
...
{
    public class RasterMultiply:ITool
    {
        ...
        {
            get { return (TextStrings.RasterMultiplyDescription); }
        }
        ...
        public string HelpText
        {
            get
            {
                return ("This will Multiply two rasters values cell by cell");
            }
        }
        ...
        public void Initialize()
        {
            ...
            _inputParam[1].HelpText = TextStrings.InputSecondRasterforMultiply;
        ...
        public string Name
        {
            get { return (TextStrings.MultiplyRasterLayers); }
        }
        ...
        {
            get { return (TextStrings.MapWindowRasterMultiply); }
        }
